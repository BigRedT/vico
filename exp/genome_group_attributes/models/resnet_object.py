...
from .embeddings import EmbeddingsConstants, Embeddings
...
class ResnetModel(io.WritableToFile,nn.Module):
    ...
    def create_object_embed(self):
        ...
        const.num_words = self.const.num_objects + 1
        const.embed_dims = self.const.num_classes
        embed = Embeddings(const)
        return embed
