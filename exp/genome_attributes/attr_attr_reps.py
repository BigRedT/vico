...
def compute_attr_attr_reps(model,dataloader,exp_const):
    ...
    print('Saving attr-attr reps and related files ...')
...
def main(exp_const,data_const,model_const):
    ...
    print('Mean Image Features Based attr-attr Reps ...')
    compute_attr_attr_reps(model,dataloader,exp_const)
