...
class ResnetNormalizedConstants(io.JsonSerializableClass):
    def __init__(self):
        super(ResnetNormalizedConstants,self).__init__()
        self.num_layers = 101
        self.pretrained = True
        self.num_classes = 1000


class ResnetNormalizedModel(io.WritableToFile,nn.Module):
    def __init__(self,const):
        super(ResnetNormalizedModel,self).__init__()
...
if __name__=='__main__':
    const = ResnetNormalizedConstants()
    const.num_layers = 18
    const.num_classes = 100
    net = ResnetNormalizedModel(const)
