  ...
  "model": {
    ...
    "text_field_embedder": {
        "token_embedders": {
            "tokens": {
                "type": "embedding",
                "pretrained_file": "/home/nfs/tgupta6/Code/visual_word_vecs/symlinks/exp/bidaf/dim_50_neg_bias_linear_concat_with_glove_100/embeddings.txt.gz",
                # https://s3-us-west-2.amazonaws.com/allennlp/datasets/glove/glove.6B.100d.txt.gz
                "embedding_dim": 150, # update 100 + D
                "trainable": false,
            },
            "token_characters": {
