...
then
    ...
    VISUAL_WORD_VECS_DIR="/home/nfs/tgupta6/Code/visual_word_vecs/symlinks/exp/multi_sense_cooccur/imagenet_genome_gt/effect_of_xforms/dim_200_neg_bias_linear/concat_with_glove_300"
