...
EXP_NAME=$3
OUT_BASE_DIR="${PWD}/symlinks/exp/semeval_2018_10/normalized_google_images_visual_word_vecs_trained_on_google"
...
then
    ...
    EMBEDDINGS_H5PY="${PWD}/symlinks/exp/google_images/normalized_resnet_embeddings_trained_on_google/concat_glove_and_visual/visual_word_vecs.h5py"
    WORD_TO_IDX_JSON="${PWD}/symlinks/exp/google_images/normalized_resnet_embeddings_trained_on_google/concat_glove_and_visual/visual_word_vecs_idx.json"
fi
